...
MapConfig.zNodes = [
    ...
    { id: 11, pId: 1, name: "宝山区域调压器", layerurl: MapConfig.searchMapUrl, layerid: "layer0", checked: false, icon: "" + getRootPath() + "Content/images/legend/0.png" },
    { id: 12, pId: 1, name: "民丰绿苑调压器", layerurl: MapConfig.searchMapUrl, layerid: "layer1", checked: false, icon: "" + getRootPath() + "Content/images/legend/1.png" },
    { id: 13, pId: 1, name: "五金百安上外调压器", layerurl: MapConfig.searchMapUrl, layerid: "layer2", checked: false, icon: "" + getRootPath() + "Content/images/legend/2.png" },
    { id: 14, pId: 1, name: "宝钱永盛调压器", layerurl: MapConfig.searchMapUrl, layerid: "layer3", checked: false, icon: "" + getRootPath() + "Content/images/legend/3.png" },
    { id: 15, pId: 1, name: "嘉定区域调压器", layerurl: MapConfig.searchMapUrl, layerid: "layer4", checked: false, icon: "" + getRootPath() + "Content/images/legend/4.png" },
    { id: 16, pId: 1, name: "高中压门站", layerurl: MapConfig.searchMapUrl, layerid: "layer5", checked: true },
    { id: 17, pId: 1, name: "高压节点", layerurl: MapConfig.searchMapUrl, layerid: "layer6", checked: false },
    { id: 18, pId: 1, name: "中压节点", layerurl: MapConfig.searchMapUrl, layerid: "layer7", checked: false },
    ...
    { id: 22, pId: 2, name: "200kpa管线", layerurl: MapConfig.searchMapUrl, layerid: "layer8", checked: true, icon: "" + getRootPath() + "Content/images/legend/gy.png" },   
    { id: 23, pId: 2, name: "250kpa管线", layerurl: MapConfig.searchMapUrl, layerid: "layer9", checked: true, icon: "" + getRootPath() + "Content/images/legend/gy.png" },
    ...
    { id: 32, pId: 3, name: "宝钱永盛", layerurl: MapConfig.searchMapUrl, layerid: "layer11", checked: false },
    { id: 33, pId: 3, name: "五金百安上外", layerurl: MapConfig.searchMapUrl, layerid: "layer12", checked: false },
    { id: 34, pId: 3, name: "绿环", layerurl: MapConfig.searchMapUrl, layerid: "layer13", checked: false },
    { id: 35, pId: 3, name: "民丰绿苑大众", layerurl: MapConfig.searchMapUrl, layerid: "layer14", checked: false },
    { id: 36, pId: 3, name: "市北", layerurl: MapConfig.searchMapUrl, layerid: "layer15", checked: true }
];
