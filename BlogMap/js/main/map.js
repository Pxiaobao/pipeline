...
(function () {
    ...
    dojo.require("heatmap.HeatmapLayer");
    //实现统计图效果需要引用
    ...
    //流向图需要引用
    dojo.require("moveEchartsMap.EchartsLayer");
    ...
    //地图加载函数
     map.on("load", function () {
        ...
        var legend = new esri.dijit.Legend({//创建图例对象
            ...
            layerInfos: [{ layer: map.getLayer("BaseMapID"), title: "图例" }],//指定显示图例的图层以及设置图例标题
